    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-30 w-64 bg-white dark:bg-slate-900 border-r border-blue-100 dark:border-slate-800 text-blue-900 dark:text-slate-100 transition duration-300 transform lg:translate-x-0 lg:static lg:inset-auto">
            ...
            <nav class="p-4 space-y-1">
                <!-- Dashboard -->
                <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-lg {{ request()->routeIs('dashboard') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-white dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                    My Bookings
                </a>
                
                <!-- Browse Vehicles -->
                <a href="{{ route('shops.index') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-lg text-blue-600 dark:text-blue-500 hover:bg-white dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white transition-colors">
                ...
                <!-- Profile -->
                <a href="{{ route('profile.edit') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-lg {{ request()->routeIs('profile.edit') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-white dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
