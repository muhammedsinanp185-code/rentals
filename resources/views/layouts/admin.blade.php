    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-30 w-64 bg-white dark:bg-slate-900 border-r border-blue-100 dark:border-slate-800 text-blue-900 dark:text-slate-100 transition duration-300 transform lg:translate-x-0 lg:static lg:inset-auto">
            <div class="flex items-center justify-center h-20 border-b border-blue-100 dark:border-slate-800 bg-white dark:bg-slate-950">
                <a href="{{ route('admin.dashboard') }}" class="text-2xl font-extrabold tracking-tight text-blue-950 dark:text-slate-100 flex flex-col items-center leading-tight">
            ...
            <nav class="p-4 space-y-1">
                <!-- Dashboard -->
                <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-md {{ request()->routeIs('admin.dashboard') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-blue-50/50 dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
                ...
                <!-- My Shop -->
                <a href="{{ route('admin.shop.edit') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-md {{ request()->routeIs('admin.shop.*') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-blue-50/50 dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
                ...
                <!-- Vehicles -->
                <a href="{{ route('admin.vehicles.index') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-md {{ request()->routeIs('admin.vehicles.*') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-blue-50/50 dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
                ...
                <!-- Categories -->
                <a href="{{ route('admin.categories.index') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-md {{ request()->routeIs('admin.categories.*') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-blue-50/50 dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
                ...
                <!-- Bookings -->
                <a href="{{ route('admin.bookings.index') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-md {{ request()->routeIs('admin.bookings.*') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-blue-50/50 dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
                ...
                @if(Auth::user()->role === 'admin')
                <!-- Customers -->
                <a href="{{ route('admin.customers.index') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-md {{ request()->routeIs('admin.customers.*') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-blue-50/50 dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
        ...
        <div class="flex-1 flex flex-col overflow-hidden dark:bg-slate-950">
            ...
            <!-- Main area -->
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-white dark:bg-slate-950 p-6">
                @if (session('success'))
