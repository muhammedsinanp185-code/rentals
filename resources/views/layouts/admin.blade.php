    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-30 w-64 bg-white dark:bg-slate-900 border-r border-blue-100 dark:border-slate-800 text-blue-900 dark:text-slate-100 transition duration-300 transform lg:translate-x-0 lg:static lg:inset-auto">
            ...
            <nav class="p-4 space-y-1">
                <!-- Dashboard -->
                <a href="{{ route('admin.dashboard') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-lg {{ request()->routeIs('admin.dashboard') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-white dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
                ...
                <!-- My Shop -->
                <a href="{{ route('admin.shop.edit') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-lg {{ request()->routeIs('admin.shop.*') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-white dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
                ...
                <!-- Vehicles -->
                <a href="{{ route('admin.vehicles.index') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-lg {{ request()->routeIs('admin.vehicles.*') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-white dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
                ...
                <!-- Categories -->
                <a href="{{ route('admin.categories.index') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-lg {{ request()->routeIs('admin.categories.*') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-white dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
                ...
                <!-- Bookings -->
                <a href="{{ route('admin.bookings.index') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-lg {{ request()->routeIs('admin.bookings.*') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-white dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
                ...
                @if(Auth::user()->role === 'admin')
                <!-- Customers -->
                <a href="{{ route('admin.customers.index') }}" class="flex items-center px-4 py-3 text-sm font-semibold rounded-lg {{ request()->routeIs('admin.customers.*') ? 'bg-blue-50 dark:bg-zinc-800 text-blue-950 dark:text-slate-100' : 'text-blue-600 dark:text-blue-500 hover:bg-white dark:hover:bg-slate-800/50 hover:text-blue-950 dark:hover:text-white' }} transition-colors">
