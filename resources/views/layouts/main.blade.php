...
<body class="font-sans antialiased bg-white dark:bg-black text-blue-950 dark:text-yellow-400">
    <nav class="bg-white/80 dark:bg-black/80 backdrop-blur-md border-b border-blue-100 dark:border-yellow-900/50 sticky top-0 z-50 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between h-20 items-center">
            <div class="flex items-center">
                ...
                @endif
                <a href="/" class="text-2xl font-extrabold tracking-tight text-blue-950 dark:text-yellow-400">DRIVE<span class="text-blue-500 font-medium">RENT</span></a>
            ...
            <div class="flex items-center space-x-6">
                ...
                @auth
                    @if(Auth::user()->role === 'admin' || Auth::user()->role === 'vendor')
                        <a href="{{ route('admin.dashboard') }}" class="hidden md:inline-block text-sm font-medium text-blue-950 dark:text-yellow-400 hover:opacity-70 transition-opacity">Dashboard</a>
                    @endif
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" x-transition.opacity class="absolute right-0 mt-2 w-48 bg-white dark:bg-[#111111] rounded-xl shadow-xl py-2 border border-blue-100 dark:border-yellow-900/50 z-50">
                            ...
                            <a href="{{ route('profile.edit') }}" class="block px-4 py-2 text-sm text-blue-800 dark:text-yellow-500 hover:bg-zinc-50 dark:hover:bg-zinc-800 hover:text-blue-950 dark:hover:text-white transition-colors">Profile Settings</a>
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="bg-[#111111] dark:bg-white text-white dark:text-blue-950 px-5 py-2.5 rounded-full text-sm font-semibold hover:opacity-90 transition-opacity">Sign Up</a>
                @endauth
            </div>
        </div>
    </nav>
    ...
    <footer class="bg-[#111111] dark:bg-gray-950 text-white py-8 text-center mt-12 border-t border-gray-700 dark:border-yellow-900/50">
