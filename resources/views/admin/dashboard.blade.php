...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 flex items-center">
        ...
        <div>
            ...
            <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['total_vehicles'] }}</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 flex items-center">
        ...
        <div>
            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Available Vehicles</p>
            <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['available_vehicles'] }}</p>
        </div>
    </div>
...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
    <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center bg-gray-50/50 dark:bg-gray-800/50">
        <h3 class="text-lg font-bold text-gray-800 dark:text-white">Recent Bookings</h3>
    ...
    @if($stats['recent_bookings']->isEmpty())
        <div class="p-8 text-center">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">No recent rental bookings found.</p>
        </div>
    @else
        <div class="overflow-x-auto">
            <table class="w-full text-left whitespace-nowrap">
                <thead>
                    <tr class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
