...
<div class="mb-4 flex justify-between items-center">
    <h3 class="text-lg font-bold dark:text-yellow-400">Manage Customers</h3>
</div>
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            @forelse ($customers as $customer)
                <tr class="hover:bg-white dark:hover:bg-gray-700/50">
                    ...
                    <td class="px-6 py-4">
                        <div class="font-medium text-blue-950 dark:text-yellow-400">{{ $customer->name }}</div>
                    </td>
                    ...
                    <td class="px-6 py-4 text-sm font-bold text-blue-950 dark:text-yellow-400">{{ $customer->bookings_count }}</td>
