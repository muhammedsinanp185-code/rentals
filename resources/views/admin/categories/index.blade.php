...
<div class="bg-white dark:bg-slate-900 rounded-lg shadow-sm overflow-hidden border dark:border-slate-800">
    <table class="w-full whitespace-nowrap">
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            @forelse ($categories as $category)
                <tr class="hover:bg-white dark:hover:bg-gray-700/50 text-blue-950 dark:text-slate-300">
                    ...
                    <td class="px-6 py-4 text-right flex justify-end gap-2">
                        <a href="{{ route('admin.categories.edit', $category) }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300" title="Edit">
            ...
            @empty
                <tr>
                    <td colspan="5" class="px-6 py-4 text-center text-blue-600 dark:text-blue-500">No categories found.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
